...
void C_plot_ESiC_Theta(int run)
{
...
// GRAPHICS
   ...
   TH1D *Htheta=new TH1D("","",1000, -10,70);  
   TH2D *HtcVSp=new TH2D("","",400, -10,70,400,0,40000);
...
// Data LOOP
   ...
   for(int i=0; i<entries;i++){
      ...
      gr1->SetPoint(i,theta_deg,energySic);  
      HtcVSp->Fill(theta_deg,energySic);   
   }
   cout<<endl;
