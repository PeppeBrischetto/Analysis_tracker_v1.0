...
void C_plot_phi(int run)
{
   ...
   l->SetTextSize(0.035);
   l->AddEntry(histoPhi, "Counts(#phi)", "lp");
   l->AddEntry(h_phi_geq2000, "Counts(#phi,E_{SiC}>2000)","lp");
   l->AddEntry(h_phi_rms, "Counts(#phi, E_{SiC}>2000,rms<2.5)","lp");
   l->AddEntry(phi_min, "#phi_{theo}-Predictions - [-1.75;1.75] (deg)","l");
   l->Draw("same");
   TLegend* l1 = new TLegend();
   l1->SetTextSize(0.035);
   l1->AddEntry(histoPhi, "Counts(#phi)", "lp");
   TLegend* l2 = new TLegend();
   l2->SetTextSize(0.035);
   l2->AddEntry(h_phi_geq2000, "Counts(#phi,E_{SiC}>2000)","lp");
   TLegend* l3 = new TLegend();
   l3->SetTextSize(0.035);
   l3->AddEntry(h_phi_rms, "Counts(#phi, E_{SiC}>2000,rms<2.5)","lp");
