#ifndef OPENFILESCLONE_H
#define OPENFILESCLONE_H
...
void openTrackCloneFile(int runnum ){
   //open file
   char *filename = new char[100];
   if(runnum<10){
      sprintf(filename, "../Tracks_Br/tracks_run00%i_th1000.root", runnum);
   }else if(runnum <100){
      sprintf(filename, "../Tracks_Br/tracks_run0%i_th1000.root", runnum);
   }else{
      //sprintf(filename, "../Tracks_Br/tracks_run%i.root", runnum);
      sprintf(filename, "../Tracks_Br/tracks_run%i_th1000.root", runnum);
   } 
