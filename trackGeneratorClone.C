...
void trackGeneratorClone(int run, bool sicFileOpen)
{
...
// OPEN output ROOT file //
   char fileOutName[50];
   if(run<10){
         sprintf(fileOutName,"Tracks_Br/tracks_run00%i_th1000.root",run);
      }else if(run <100){
         sprintf(fileOutName,"Tracks_Br/tracks_run0%i_th1000.root",run);
      }else{
         sprintf(fileOutName,"Tracks_Br/tracks_run%i_th1000.root",run);
      } 
