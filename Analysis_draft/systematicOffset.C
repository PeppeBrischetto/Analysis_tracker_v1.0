//#################################################################################################################
//#   This macro allows to evaluate the systematic offset for each track events.
//#################################################################################################################
...
// Variables
   ...
   for(int i=0; i<NRows; i++){
      ...
      discr[i]=new TH1D(histoname,histoname,500,-15,15);
   ...
   for(int i=0; i<NRows; i++){
      ...
      amplitude[i]=new TH1D(histoname,histoname,500,-15,15);
...
// Graphyical cut definition
  ...
  cutG->SetPoint(6,44.068,96.1617);                                                         
...
// Data loop
   for(Int_t i=0; i<entries; i++){
      ...
      if(i==0 || i==100 || i==200 || i==300 || i==400 || i==500 || i==600 || i==700){
         ...
         c_retta->Update();
         char tit_retta[100];
         sprintf(tit_retta,"Tracks/Run%d/bestTrack%d__NEW_cut_th.png",run,i);
   ...
   char tFile[100];
   sprintf(tFile,"TrackQuality_txtFiles/qualityTest_run%d_cut_th.txt",run);
   outfile.open(tFile);
   ...
   char titolo0[100];
   sprintf(titolo0,"TrackQualityControl/Run%d/offset_run%d_cut_th.png",run,run);
   char titolo1[100];
   sprintf(titolo1,"TrackQualityControl/Run%d/Amplitudes_run%d_cut_th.png",run,run);
   char titolo2[100];
   sprintf(titolo2,"TrackQualityControl/Run%d/chi_run%d_cut_th.png",run,run);
   c->SaveAs(titolo0);
   c1->SaveAs(titolo1);
   c2->SaveAs(titolo2);
   ...
   h_intercetta->Draw();
   char titolo3[100];
   sprintf(titolo3,"TrackQualityControl/Run%d/theta_intercetta%d_th.png",run,run);
   c3->SaveAs(titolo3);
   ...
   h_corr->Draw();
   char titolo4[100];
   sprintf(titolo4,"TrackQualityControl/Run%d/pearson_%d_cut_th.png",run,run);
   c4->SaveAs(titolo4);
   ...
   char titolo5[100];
   sprintf(titolo5,"TrackQualityControl/Run%d/errX_run%d_cut_th.png",run,run);
   c5->SaveAs(titolo5);
   ...
   h_foc->Draw();
   char titolo6[100];
   sprintf(titolo6,"TrackQualityControl/Run%d/x_foc_run%d_cut_th.png",run,run);
   c6->SaveAs(titolo6);
   ...
   h_errQ->Draw();
   char titolo7[100];
   sprintf(titolo7,"TrackQualityControl/Run%d/errMQ_run%d_cut_th.png",run,run);
   c7->SaveAs(titolo7);
