...
void plotALL_resolution_vs_primaries(){

//####################################################################################################################
// Needed variables
   Int_t p = 0;
   Double_t np_10c[1] = {95834.};                  // Number of primary electrons - obtained dividing energy loss (by LISE++) and the average ioization potential (23.4 eV)
   Double_t np_20c[1] = {203948.};
   Double_t sp_10c[1] = {2.98E+08};                 // Number of secondary electrons - obtained converting the digitizer signal (in mV) in # e- -> digi * 61e-3/7.24e-5    
   Double_t sp_20c[1] = {1.0E+9};
   ...
   TGraphErrors *gr_10r12c_20 = new TGraphErrors(1,np_10c,resol10_12c_20,0,err_resol10_12c_20);     
   gr_10r12c_20->SetTitle("#deltax vs N_{primaries} - R = 20 Hz");
   gr_10r12c_20->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r12c_200 = new TGraphErrors(1,np_10c,resol10_12c_200,0,err_resol10_12c_200);     
   gr_10r12c_200->SetTitle("#deltax vs N_{primaries} - R = 200 Hz");
   gr_10r12c_200->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r12c_1000 = new TGraphErrors(1,np_10c,resol10_12c_1000,0,err_resol10_12c_1000);     
   gr_10r12c_1000->SetTitle("#deltax vs N_{primaries} - R = 1000 Hz");
   gr_10r12c_1000->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r12c_3000 = new TGraphErrors(1,np_10c,resol10_12c_3000,0,err_resol10_12c_3000);     
   gr_10r12c_3000->SetTitle("#deltax vs N_{primaries} - R = 3000 Hz");
   gr_10r12c_3000->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r7li_2000 = new TGraphErrors(1,np_li,resol10_7li_2000,0,err_resol10_7li_2000);     
   gr_10r7li_2000->SetTitle("#deltax vs N_{primaries} - R = 2000 Hz");
   gr_10r7li_2000->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r16o_200 = new TGraphErrors(1,np_o,resol10_16o_200,err_resol10_16o_200);     
   gr_10r16o_200->SetTitle("#deltax vs N_{primaries} - R = 2000 Hz");
   gr_10r16o_200->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_20r12c_20 = new TGraphErrors(1,np_20c,resol20_12c_20,0,err_resol10_12c_20);     
   gr_20r12c_20->SetTitle("#deltax vs N_{primaries} - R = 20 Hz");
   gr_20r12c_20->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_20r12c_200 = new TGraphErrors(1,np_20c,resol20_12c_200,0,err_resol10_12c_200);     
   gr_20r12c_200->SetTitle("#deltax vs N_{primaries} - R = 200 Hz");
   gr_20r12c_200->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_20r12c_1000 = new TGraphErrors(1,np_20c,resol20_12c_1000,0,err_resol10_12c_1000);     
   gr_20r12c_1000->SetTitle("#deltax vs N_{primaries} - R = 1000 Hz");
   gr_20r12c_1000->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_20r12c_3000 = new TGraphErrors(1,np_20c,resol20_12c_3000,0,err_resol10_12c_3000);     
   gr_20r12c_3000->SetTitle("#deltax vs N_{primaries} - R = 3000 Hz");
   gr_20r12c_3000->GetXaxis()->SetTitle("N_{primaries}");
...
// THGEM + RIM
   ...
   TGraphErrors *gr_10r7Li_20R = new TGraphErrors(1,np_li,resol10_7li_20R,0,err_resol10_7li_20R);     
   gr_10r7Li_20R->SetTitle("#deltax vs N_{primaries} - R = 20 Hz");
   gr_10r7Li_20R->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r7Li_300R = new TGraphErrors(1,np_li,resol10_7li_300R,0,err_resol10_7li_300R);     
   gr_10r7Li_300R->SetTitle("#deltax vs N_{primaries} - R = 300 Hz");
   gr_10r7Li_300R->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r7Li_1000R = new TGraphErrors(1,np_li,resol10_7li_1000R,0,err_resol10_7li_1000R);     
   gr_10r7Li_1000R->SetTitle("#deltax vs N_{primaries} - R = 1000 Hz");
   gr_10r7Li_1000R->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r7Li_2000R = new TGraphErrors(1,np_li,resol10_7li_2000R,0,err_resol10_7li_2000R);     
   gr_10r7Li_2000R->SetTitle("#deltax vs N_{primaries} - R = 2000 Hz");
   gr_10r7Li_2000R->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r7Li_3000R = new TGraphErrors(1,np_li,resol10_7li_3000R,0,err_resol10_7li_3000R);     
   gr_10r7Li_3000R->SetTitle("#deltax vs N_{primaries} - R = 3000 Hz");
   gr_10r7Li_3000R->GetXaxis()->SetTitle("N_{primaries}");
   ...
   TGraphErrors *gr_10r12c_260R = new TGraphErrors(1,np_10c,resol10_12c_260R,0,err_resol10_12c_260R);     
   gr_10r12c_260R->SetTitle("#deltax vs N_{primaries} - R = 260 Hz");
   gr_10r12c_260R->GetXaxis()->SetTitle("N_{primaries}");
...
// Visualization block
   ...
   TH2F *bga=new TH2F("bga","#deltax vs N_{primaries}",100,1.E+4,2.4E+5,1000,0.4,4);
   bga->SetStats(0);
   bga->GetXaxis()->SetTitle("N_{primaries}");
