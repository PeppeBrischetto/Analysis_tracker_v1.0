...
// Data loop
   ...
   char titolo0[100];
   sprintf(titolo0,"Pictures_Analysis/TrackQualityControl/Run%d/Discrepancies_run%d_corr.png",run,run);
   char titolo1[100];
   sprintf(titolo1,"Pictures_Analysis/TrackQualityControl/Run%d/Amplitudes_run%d_corr.png",run,run);
   char titolo2[100];
   sprintf(titolo2,"Pictures_Analysis/TrackQualityControl/Run%d/chi_run%d_corr.png",run,run);
   c->SaveAs(titolo0);
   c1->SaveAs(titolo1);
   c2->SaveAs(titolo2);
   ...
   h_intercetta->Draw();
   char titolo3[100];
   sprintf(titolo3,"Pictures_Analysis/TrackQualityControl/Run%d/theta_intercetta%d_corr.png",run,run);
   c3->SaveAs(titolo3);
   ...
   h_corr->Draw();
   char titolo4[100];
   sprintf(titolo4,"Pictures_Analysis/TrackQualityControl/Run%d/pearson_%d_corr.png",run,run);
   c4->SaveAs(titolo4);
   ...
   char titolo5[100];
   sprintf(titolo5,"Pictures_Analysis/TrackQualityControl/Run%d/errX_run%d_corr.png",run,run);
   c5->SaveAs(titolo5);
   ...
   h_foc->Draw();
   char titolo6[100];
   sprintf(titolo6,"Pictures_Analysis/TrackQualityControl/Run%d/x_foc_run%d_corr.png",run,run);
   c6->SaveAs(titolo6);
}
