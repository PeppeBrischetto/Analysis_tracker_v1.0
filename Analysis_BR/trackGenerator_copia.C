...
void trackGenerator_copia(int run, bool sicFileOpen)
{
...
// OPEN output ROOT file //
   char fileOutName[50];
   if(run<10){
         sprintf(fileOutName,"../Tracks_Br/tracks_run00%i_proof.root",run);
      }else if(run <100){
         sprintf(fileOutName,"../Tracks_Br/tracks_run0%i_proof.root",run);
      }else{
         sprintf(fileOutName,"../Tracks_Br/tracks_run%i_proof.root",run);
      } 
