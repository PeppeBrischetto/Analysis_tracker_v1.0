...
//#   updated :  8 Oct 2024 Inclusion of the intercept as a variable in the "tree" of the output file - O. Sgouros
//#################################################################################################################
...
// Dichiarazione variabili
  ...
  // output file variables
   ...
   Double_t inter;		// intercept of the linear equation describing the ion trajectory (in mm)
   Double_t phi;
   Double_t phi_deg;
...
// OPEN output ROOT file //
   ...
   treeOut->Branch("intercept",&inter,"intercept/D");
